...
#include "../../thirdparty/SFML/include/SFML/Config.hpp"
#include "../../thirdparty/SFML/include/SFML/Graphics/Color.hpp"
#include "../../thirdparty/SFML/include/SFML/Graphics/RenderTarget.hpp"
#include "../../thirdparty/SFML/include/SFML/Graphics/RenderTexture.hpp"
#include "../../thirdparty/SFML/include/SFML/Graphics/RenderWindow.hpp"
#include "../../thirdparty/SFML/include/SFML/Graphics/Sprite.hpp"
#include "../../thirdparty/SFML/include/SFML/Graphics/Texture.hpp"
#include "../../thirdparty/SFML/include/SFML/OpenGL.hpp"
#include "../../thirdparty/SFML/include/SFML/Window/Clipboard.hpp"
#include "../../thirdparty/SFML/include/SFML/Window/Cursor.hpp"
#include "../../thirdparty/SFML/include/SFML/Window/Event.hpp"
#include "../../thirdparty/SFML/include/SFML/Window/Touch.hpp"
#include "../../thirdparty/SFML/include/SFML/Window/Window.hpp"
...
ImU32 ColorConvertFloat4ToU32(ImVec4 color)
{
    ImU32 r = (ImU32)(fminf(fmaxf(color.x, 0.0f), 1.0f) * 255.0f + 0.5f);
    ImU32 g = (ImU32)(fminf(fmaxf(color.y, 0.0f), 1.0f) * 255.0f + 0.5f);
    ImU32 b = (ImU32)(fminf(fmaxf(color.z, 0.0f), 1.0f) * 255.0f + 0.5f);
    ImU32 a = (ImU32)(fminf(fmaxf(color.w, 0.0f), 1.0f) * 255.0f + 0.5f);

    return ((a << 24) | (b << 16) | (g << 8) | r);
}

bool ImGui_ImplSFML_Init(sf::RenderWindow *window, bool loadDefaultFont)
{
    return Init(*window, loadDefaultFont);
}

void ImGui_ImplSFML_Shutdown(sf::RenderWindow *window)
{
    return Shutdown(*window);
}

void ImGui_ImplSFML_Update(sf::RenderWindow *window, sf::Time dt)
{
    Update(*window, dt);
}

void ImGui_ImplSFML_Render(sf::RenderWindow *window)
{
    Render(*window);
}

void ImGui_ImplSFML_ProcessEvent(sf::RenderWindow *window, sf::Event *event)
{
    ProcessEvent(*window, *event);
}

bool ImGui_ImplSFML_UpdateFontTexture()
{
    return UpdateFontTexture();
}
...
extern "C"
{
    bool cimgui_ImGui_ImplSFML_Init(void *window, bool load_default_font)
    {
        assert(window && "Window pointer is null - forgot to call ImGui::SFML::Init?");
        sf::RenderWindow *sfWindow = static_cast<sf::RenderWindow *>(window);
        return ImGui_ImplSFML_Init(sfWindow, load_default_font);
    }
    ...
    void cimgui_ImGui_ImplSFML_Shutdown(void *window)
    {
        assert(window && "Window pointer is null - forgot to call ImGui::SFML::Init?");
        sf::RenderWindow *sfWindow = static_cast<sf::RenderWindow *>(window);
        ImGui_ImplSFML_Shutdown(sfWindow);
    }

    void cimgui_ImGui_ImplSFML_ProcessEvent(void *window, void *event)
    {
        assert(window && "Window pointer is null - forgot to call ImGui::SFML::Init?");
        assert(event && "Event pointer is null - forgot to call ImGui::SFML::ProcessEvent?");
        sf::RenderWindow *sfWindow = static_cast<sf::RenderWindow *>(window);
        sf::Event *sfEvent = static_cast<sf::Event *>(event);
        ImGui_ImplSFML_ProcessEvent(sfWindow, sfEvent);
    }
    ...
    void cimgui_ImGui_ImplSFML_Update(void *window, uint64_t dtUs)
    {
        assert(window && "Window pointer is null - forgot to call ImGui::SFML::Init?");
        sf::RenderWindow *sfWindow = static_cast<sf::RenderWindow *>(window);
        sf::Time dt = sf::microseconds(dtUs);
        ImGui_ImplSFML_Update(sfWindow, dt);
    }
    ...
    void cimgui_ImGui_ImplSFML_Render(void *window)
    {
        assert(window && "Window pointer is null - forgot to call ImGui::SFML::Init?");
        sf::RenderWindow *sfWindow = static_cast<sf::RenderWindow *>(window);
        ImGui_ImplSFML_Render(sfWindow);
    }
