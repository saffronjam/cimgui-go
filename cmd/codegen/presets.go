...
type Preset struct {
	...
	// Example:
	//   "github.com/saffronjam/cimgui-go"
	//   If enerated with -pkg imgui, import path
	//   is supposed to be "github.com/saffronjam/cimgui-go/imgui"
	PackagePath string
	...
	// github.com/saffronjam/cimgui-go/internal.WrappableType[CTYPE, SELF]
